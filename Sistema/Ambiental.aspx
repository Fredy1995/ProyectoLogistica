<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ambiental.aspx.cs" Inherits="Sistema.Ambiental" %>
			...
			<section id="menu">
				<div><span id="cerrar_Menu" class="icon icon-cross"></span></div><hr />
					<ul>
                        ...
                        <asp:LinkButton ID="LbtnAmbiental" runat="server"><span class="icon icon-leaf"></span> Ambiental</asp:LinkButton>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-xs-12" >
						<h4 runat="server" visible="true" id="TitleS" class="card-header">HISTORIAL DE RENTABILIDAD-<strong>AMBIENTAL</strong></h4>
						<h4 runat="server" visible="false" id="TitleSC" class="card-header">AMBIENTAL - <strong>CONTRATOS</strong></h4>
					    <h4 runat="server" visible="false" id="TitleCAnual" class="card-header">CONSOLIDADO ANUAL - <strong>AMBIENTAL</strong></h4>
                </div>
            </div>
		</div><br />
