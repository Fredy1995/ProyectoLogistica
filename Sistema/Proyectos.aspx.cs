...
namespace Sistema
{
    public partial class Proyectos : System.Web.UI.Page
    {
        ...
        const double porcentajeIC = 0.0315, porcentajeIO = 0.1239; //Variables como CONSTANTES
        ...
        protected int ObtenerIdArea() //METODO que devuelve el Id del area
        {
            try
            {
                ...
                using (con)
                {
                    String queryArea = "Select IdArea From Areas Where Area = 'Proyectos'"; //Consulta para obtener el IdArea de Supervision
                    OrdenSql = new SqlCommand(queryArea, con);
                    con.Open();
