...
namespace Sistema
{
    public partial class Construccion : System.Web.UI.Page
    {
        ...
        const double porcentajeIC = 0.088, porcentajeIO = 0.1239; //Variables como CONSTANTES
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                LbtnConstruccion.Enabled = false;
            }
        ...
        protected void LlenarFilasTablaAnual(int IdContrato, string FechaR, DataRow Fila)
        {
            ...
            Fila[0] = "Proyectos de Infraestructura de Vías Terrestres";
        ...
        protected int ObtenerIdArea() //METODO que devuelve el Id del area
        {
            try
            {
                ...
                using (con)
                {
                    String queryArea = "Select IdArea From Areas Where Area = 'Construccion'"; //Consulta para obtener el IdArea de Supervision
                    OrdenSql = new SqlCommand(queryArea, con);
                    con.Open();
