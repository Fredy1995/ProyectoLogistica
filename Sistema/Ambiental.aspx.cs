...
namespace Sistema
{
    public partial class Ambiental : System.Web.UI.Page
    {
        ...
        const double porcentajeIC = 0.0574, porcentajeIO = 0.1239; //Variables como CONSTANTES
        ...
        protected void LlenarFilasTablaAnual(int IdContrato, string FechaR, DataRow Fila)
        {
            ...
            Fila[0] = "Elaboración de Estudios de Impacto Ambiental y Ejecución de Programas Ambientales";
        ...
        protected void LbtnAnual_Click(object sender, EventArgs e) //Evento del botón Tabla Anual
        {
            ...
            //Mostrar los controles desables
        ...
        protected void CargarDDlFechasInicialFinal() //Metodo para cargar las listas despegables del Mes Inicial y Mes Final
        {
        ...
        protected int ObtenerIdArea() //METODO que devuelve el Id del area
        {
            try
            {
                ...
                using (con)
                {
                    String queryArea = "Select IdArea From Areas Where Area = 'Ambiental'"; //Consulta para obtener el IdArea de Supervision
                    OrdenSql = new SqlCommand(queryArea, con);
                    con.Open();
        ...
        protected Boolean ExisteRepEnContrato(Int64 idcontrato) //Metodo que se encarga de hacer una consulta en la Tabla Reportes y Ves si existen Reportes que correspondan a los contratos agregados
        {
            try
            {
                con = new SqlConnection(strConexion);
