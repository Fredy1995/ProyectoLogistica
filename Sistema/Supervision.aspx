<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supervision.aspx.cs" Inherits="Sistema.Supervision" %>
			...
			<section id="menu">
				<div><span id="cerrar_Menu" class="icon icon-cross"></span></div><hr />
					<ul>
                        ...
                        <asp:LinkButton ID="LbtnSupervision" runat="server"><span class="icon icon-quill"></span> Supervisión</asp:LinkButton>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-xs-12" >
						<h4 runat="server" visible="true" id="TitleS" class="card-header">HISTORIAL DE RENTABILIDAD-<strong>SUPERVISIÓN</strong></h4>
						<h4 runat="server" visible="false" id="TitleSC" class="card-header">SUPERVISIÓN - <strong>CONTRATOS</strong></h4>
					    <h4 runat="server" visible="false" id="TitleCAnual" class="card-header">CONSOLIDADO ANUAL - <strong>SUPERVISIÓN</strong></h4>
                </div>
            </div>
		</div><br />
            ...
            <div class="row">
						...
						<div class="form-inline">
							...
							<asp:Label ID="LblDdlAnual" runat="server" Text="Año:" Visible="false" CssClass="mb-1 mr-sm-2"></asp:Label>
							 ...
							 <asp:Label ID="lblA" runat="server" Text="a" CssClass="mb-1 mr-sm-2"></asp:Label>
								...
								<div class="input-group">
								<asp:LinkButton ID="LbtnGraficaArea" runat="server" CssClass="btn btn-outline-success mb-2 mr-sm-2" Visible ="true" OnClick="LbtnGraficaArea_Click" ><span class="icon icon-stats-dots"></span> Gráfica</asp:LinkButton>
					...
					<div runat="server" id="MenuContratos" visible="false">
						...
						<div class="input-group">
							...
							<asp:DropDownList ID="DdlAnioC" runat="server" CssClass="form-control mb-2 mr-sm-2"  Visible="false" ></asp:DropDownList> 
						</div>
						<div class="input-group">
